 ...
 */
class getBorrowingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BorrowingRepository' shared autowired service.
     *
     * @return \App\Repository\BorrowingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BorrowingRepository.php';

        return $container->privates['App\\Repository\\BorrowingRepository'] = new \App\Repository\BorrowingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
