...
/* book/add.html.twig */
class __TwigTemplate_4d2e57e105c07ff44df556ee2168489b extends Template
{
...
<main class=\"admin-login-page\" style=\"background-color: #ffc5c5; color: #333; display: flex; justify-content: center; padding: 40px; min-height: 80vh;\">
    <section class=\"login-form-container\" style=\"width: 100%; max-width: 500px; background-color: #fff; padding: 40px; border-radius: 15px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.6);\">
        <h1 style=\"text-align: center; color: #000; font-size: 2rem; margin-bottom: 10px;\">Ajouter un livre</h1>
        <p style=\"text-align: center; font-size: 1rem; color: #555; margin-bottom: 30px;\">Entrez les informations du livre que vous souhaitez ajouter</p>
...
{% endblock %}
", "book/add.html.twig", "C:\\Users\\marwa\\biblioverse\\templates\\book\\add.html.twig");
    }
}
