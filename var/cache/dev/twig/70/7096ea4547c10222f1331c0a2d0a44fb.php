...
class __TwigTemplate_f9aaf7efd89af7ceb1f5be998e9e8555 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "user/settings.html.twig", 2);
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 7
        yield "    <h1>Paramètres du compte</h1>
    ...
    ";
        ...
        <p><strong>Prénom :</strong> ";
            // line 11
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11), "surname", [], "any", false, false, false, 11), "html", null, true);
            yield "</p>
        ...
        <p><strong>CIN :</strong> ";
            // line 13
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "cin", [], "any", false, false, false, 13), "html", null, true);
            yield "</p>
        <p><strong>Date de naissance :</strong> ";
            // line 14
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "user", [], "any", false, false, false, 14), "dateOfBirth", [], "any", false, false, false, 14), "d/m/Y"), "html", null, true);
            yield "</p>
    ...
    ";
            ...
            // line 18
            yield "        <p>Vous devez être connecté pour accéder à cette page.</p>
    ";
        }
    ...
    {
        return array (  133 => 18,  128 => 16,  123 => 14,  119 => 13,  115 => 12,  111 => 11,  106 => 10,  104 => 9,  100 => 7,  87 => 6,  64 => 4,  41 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{# templates/user/settings.html.twig #}
...
{% block body %}
    ...
    {% if app.user %}
        ...
        <p><strong>Prénom :</strong> {{ app.user.surname }}</p>
        <p><strong>Email :</strong> {{ app.user.email }}</p>
        <p><strong>CIN :</strong> {{ app.user.cin }}</p>
    ...
    {% endif %}
{% endblock %}
", "user/settings.html.twig", "C:\\Users\\marwa\\biblioverse\\templates\\user\\settings.html.twig");
    }
}
