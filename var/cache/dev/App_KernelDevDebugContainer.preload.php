...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerHEnCCpH\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerHEnCCpH/EntityManagerGhost614a58f.php';
require __DIR__.'/ContainerHEnCCpH/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/ContainerHEnCCpH/getWebpackEncore_TagRendererService.php';
require __DIR__.'/ContainerHEnCCpH/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/ContainerHEnCCpH/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerHEnCCpH/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerHEnCCpH/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerHEnCCpH/getValidator_WhenService.php';
require __DIR__.'/ContainerHEnCCpH/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerHEnCCpH/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerHEnCCpH/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerHEnCCpH/getValidator_ExpressionService.php';
require __DIR__.'/ContainerHEnCCpH/getValidator_EmailService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Runtime_ImportmapService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerHEnCCpH/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerHEnCCpH/getTurbo_Doctrine_EventListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerHEnCCpH/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerHEnCCpH/getTexter_TransportsService.php';
require __DIR__.'/ContainerHEnCCpH/getStimulus_UxControllersTwigRuntimeService.php';
require __DIR__.'/ContainerHEnCCpH/getStimulus_AssetMapper_LoaderJavascriptCompilerService.php';
require __DIR__.'/ContainerHEnCCpH/getStimulus_AssetMapper_ControllersMapGeneratorService.php';
require __DIR__.'/ContainerHEnCCpH/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerHEnCCpH/getSession_FactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getServicesResetterService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerHEnCCpH/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getSecrets_VaultService.php';
require __DIR__.'/ContainerHEnCCpH/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerHEnCCpH/getRouting_LoaderService.php';
require __DIR__.'/ContainerHEnCCpH/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerHEnCCpH/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/ContainerHEnCCpH/getMonolog_Logger_MessengerService.php';
require __DIR__.'/ContainerHEnCCpH/getMonolog_Logger_MailerService.php';
require __DIR__.'/ContainerHEnCCpH/getMonolog_Logger_DeprecationService.php';
require __DIR__.'/ContainerHEnCCpH/getMonolog_Logger_AssetMapperService.php';
require __DIR__.'/ContainerHEnCCpH/getMonolog_LoggerService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_TransportFactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Transport_InMemory_FactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Transport_FailedService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Transport_AsyncService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Bus_Default_Middleware_SendMessageService.php';
require __DIR__.'/ContainerHEnCCpH/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/ContainerHEnCCpH/getMailer_TransportsService.php';
require __DIR__.'/ContainerHEnCCpH/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerHEnCCpH/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerHEnCCpH/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerHEnCCpH/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerHEnCCpH/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Password_PasswordHasherService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Form_PasswordHasherService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_Type_FormService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_Type_FileService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_Type_EntityService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_Type_ColorService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_ServerParamsService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_RegistryService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_Listener_PasswordHasherService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_FactoryService.php';
require __DIR__.'/ContainerHEnCCpH/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerHEnCCpH/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerHEnCCpH/getErrorControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Messenger_DoctrineSchemaListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerHEnCCpH/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerHEnCCpH/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerHEnCCpH/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerHEnCCpH/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerHEnCCpH/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerHEnCCpH/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerHEnCCpH/getContainer_GetenvService.php';
require __DIR__.'/ContainerHEnCCpH/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerHEnCCpH/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerHEnCCpH/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerHEnCCpH/getCache_SystemClearerService.php';
require __DIR__.'/ContainerHEnCCpH/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerHEnCCpH/getCache_AppClearerService.php';
require __DIR__.'/ContainerHEnCCpH/getAssetMapper_Importmap_GeneratorService.php';
require __DIR__.'/ContainerHEnCCpH/getAssetMapper_Importmap_ConfigReaderService.php';
require __DIR__.'/ContainerHEnCCpH/getAssetMapper_Compiler_JavascriptImportPathCompilerService.php';
require __DIR__.'/ContainerHEnCCpH/getAssetMapper_Compiler_CssAssetUrlCompilerService.php';
require __DIR__.'/ContainerHEnCCpH/getTemplateControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getRedirectControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getProfilerControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getUserRepositoryService.php';
require __DIR__.'/ContainerHEnCCpH/getHistoryRepositoryService.php';
require __DIR__.'/ContainerHEnCCpH/getContactRepositoryService.php';
require __DIR__.'/ContainerHEnCCpH/getBorrowingRepositoryService.php';
require __DIR__.'/ContainerHEnCCpH/getBookRepositoryService.php';
require __DIR__.'/ContainerHEnCCpH/getSignUpTypeService.php';
require __DIR__.'/ContainerHEnCCpH/getReturnTypeService.php';
require __DIR__.'/ContainerHEnCCpH/getContactTypeService.php';
require __DIR__.'/ContainerHEnCCpH/getBorrowingTypeService.php';
require __DIR__.'/ContainerHEnCCpH/getBookTypeService.php';
require __DIR__.'/ContainerHEnCCpH/getUserControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getHomeControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getHistoryControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getBorrowingControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getBookControllerService.php';
require __DIR__.'/ContainerHEnCCpH/getUserControllersignUpService.php';
require __DIR__.'/ContainerHEnCCpH/getUserControllersignInService.php';
require __DIR__.'/ContainerHEnCCpH/getHistoryControllerindexService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_JsQaLu1Service.php';
require __DIR__.'/ContainerHEnCCpH/getBorrowingControllerreturnBookService.php';
require __DIR__.'/ContainerHEnCCpH/getBorrowingControllerborrowService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_Y01gEBAService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_QaaoWjxService.php';
require __DIR__.'/ContainerHEnCCpH/getBorrowingControllerlistBorrowingsService.php';
require __DIR__.'/ContainerHEnCCpH/getBookControllerlistBooksService.php';
require __DIR__.'/ContainerHEnCCpH/getBookControllereditBookService.php';
require __DIR__.'/ContainerHEnCCpH/getBookControllerdeleteBookService.php';
require __DIR__.'/ContainerHEnCCpH/getBookControlleraddBookService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_P_BlNFLService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_4wc4Ag1_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_4wc4Ag1_KernelloadRoutesService.php';
require __DIR__.'/ContainerHEnCCpH/get_ServiceLocator_4wc4Ag1Service.php';
require __DIR__.'/ContainerHEnCCpH/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_JyyWvHwService.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_GEx8y9aService.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_WG_ORBvService.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_UKIJHilService.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_Qv3faSNService.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_NumTeF8Service.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_EXsqOW5Service.php';
require __DIR__.'/ContainerHEnCCpH/get_Messenger_HandlerDescriptor_Die6BxeService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerHEnCCpH/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\BorrowingController';
...
$classes[] = 'App\Form\BorrowingType';
$classes[] = 'App\Form\ContactType';
$classes[] = 'App\Form\ReturnType';
$classes[] = 'App\Form\SignUpType';
$classes[] = 'App\Repository\BookRepository';
$classes[] = 'App\Repository\BorrowingRepository';
